...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent"> 
    <ul class="navbar-nav ml-auto">
       ...
       <li class="nav-item ">
           <a class="nav-link " href="administrador1.php"><font color="white">INICIO</a></font>
      </li>
     
      
       <li class="nav-item">
        <a class="nav-link" href="#"><font color="white">ATLETA</font></a>
      </li>
        
         <li class="nav-item">
        <a class="nav-link" href="areatecnica.php"><font color="white">AREA. TECNICA</font></a>
      </li>
        
         <li class="nav-item">
        <a class="nav-link" href="areamedica.php"><font color="white">AREA. MEDICA</font></a>
      </li>
