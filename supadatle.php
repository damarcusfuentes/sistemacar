...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent"> 
   ...
   <div class="card-deck" >
       ...
       <div class="card">
    <img class="card-img-top img-fluid" src="img\modulos\atleta\citamedi.jpg"  width="318" height="180" alt="Card image cap">
    <div class="card-body">
       <center>   <h4 class="card-title">CITAS MEDICAS</h4>
  ...
  <div class="card">
    <img class="card-img-top img-fluid" src="img\modulos\atleta\plannutri.jpg"  width="318" height="180" alt="Card image cap">
    <div class="card-body">
     <center>  <h4 class="card-title">PLAN NUTRICIONAL</h4>
    <a class="btn btn-primary btn-sm" href="#" role="button">INGRESAR</a> </center>
    </div>
  </div>
  ...
  <div class="card">
    <img class="card-img-top  img-fluid" src="img\modulos\atleta\compe.jpg"  width="318" height="180" alt="Card image cap">
    <div class="card-body">
      <center><h4 class="card-title">COMPETENCIAS</h4>
   <a class="btn btn-primary btn-sm" href="#" role="button">INGRESAR</a> </center>
    </div>
  </div>
