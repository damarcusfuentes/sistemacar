...
<html lang="en">
    ...
    <ul class="navbar-nav ml-auto">
       ...
       <li class="nav-item">
        <a class="nav-link" href="atletas.php"><font color="blue">ATLETA</font></a>
         ...
         <li class="nav-item">
        <a class="nav-link" href=""><font color="blue">AREA. TECNICA</font></a>
      </li>
 ...
 <section class="container mt-5 pt-5">
  <a class="btn btn-primary btn-sm" href="areamedica.php" role="button">REGRESAR</a> 

      <br>
	  <br>
       <center><h3> PSICOLOGIA</h3></center>
